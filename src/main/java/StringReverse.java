...
public class StringReverse {
     ...
     *
     * You could do some math to grab characters from the end of the String using a
     * typical for loop.
     * For instance, you could use build a String by writing a for loop that
     * decrements rather than increments, grabbing
